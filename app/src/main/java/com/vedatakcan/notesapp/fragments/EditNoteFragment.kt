...
import com.vedatakcan.notesapp.databinding.FragmentEditNoteBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.editNoteFab.setOnClickListener {
            ...
            if (noteTitle.isNotEmpty()) {
                ...
                Toast.makeText(context, "Lütfen bir not başlığı girin", Toast.LENGTH_SHORT).show()
            }
        }
    }
    ...
    private fun deleteNote(){
        activity?.let {
            AlertDialog.Builder(it).apply {
                setTitle(" Notu sil")
                setMessage("Notu silmek istiyor musun?")
